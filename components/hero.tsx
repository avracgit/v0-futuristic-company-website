      ...
      <div className="relative z-10 min-h-screen flex items-center px-8 md:px-16 lg:px-20 pointer-events-none">
        <div className="max-w-lg lg:max-w-xl fade-in-up pointer-events-auto">
          ...
          <div className="flex flex-col sm:flex-row items-start gap-4">
            <Link href="/services" className="btn-primary backdrop-blur-sm">
              Explore Services
              <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                <path strokeLinecap="round" strokeLinejoin="round" d="M17 8l4 4m0 0l-4 4m4-4H3" />
              </svg>
            </Link>
            <Link href="/contact" className="btn-ghost glass-button">
              Contact Us
            </Link>
          </div>

          <div className="mt-20">
            <div className="flex items-center gap-2 text-xs text-[var(--text-muted)] glass-badge px-3 py-2 rounded-full w-fit">
